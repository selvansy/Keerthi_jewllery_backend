...
//   async giftIssuesDataTable({ query = {}, documentskip = 0, documentlimit = 10 }) {
//     try {
//         console.log("query---",query)
//         const matchStage = {};

//         if (query.mobile) {
//             matchStage["customer.mobile"] = { $regex: query.mobile, $options: "i" };
//             delete query.mobile;
//         }
...
//         const result = await giftIssuesModel.aggregate(aggregationPipeline);
...
// }
  ...
  //   try {
  //     const data = await giftIssuesModel.aggregate([
  //       { $match: query },
  //       { $unwind: '$gifts' }, 
  //       {
  //         $facet: {
